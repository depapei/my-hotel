...
const Navigation = () => {
  ...
  return (
    <>
      <nav className={`lg:hidden flex flex-col justify-center items-left w-full ${isNavbarVisible ? "bg-blue-500 opacity-100" : "bg-opacity-0"} transition-all duration-500`}>
        ...
        <div className={`${mobileMenu ? 'flex flex-col gap-4 p-4' : ' opacity-0 h-0'} transition-all`}>
