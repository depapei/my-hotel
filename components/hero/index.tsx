export const Hero = () => {
  return (
    <section className="flex flex-wrap mt-16" id="#home">
      <div className="w-full sm:w-8/12 mb-10">
        <div className="container mx-auto h-full sm:p-10">
          <nav className="flex px-4 justify-between items-center">
            <div className="text-4xl font-bold">
              My Hotel<span className="text-blue-600">.</span>
            </div>
            <div>
              <img
          ...
          <header className="container px-4 lg:flex mt-10 items-center h-full lg:mt-0">
            <div className="w-full">
              <h1 className="text-4xl lg:text-6xl font-bold">
                Find your <span className="text-blue-600">bluey</span> stuff for
                your room
              </h1>
              ...
              <button className="bg-blue-600 text-white text-2xl font-medium px-4 py-2 rounded shadow">
                Learn More
              </button>
            </div>
          </header>
