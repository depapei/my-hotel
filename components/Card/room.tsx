export const RoomCard = (props: {
  ...
  return (
    <div
      className="w-full group overflow-hidden bg-white rounded-3xl p-6 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:scale-105 hover:shadow-3xl lg:m-0"
      onClick={onClick}
    >
      ...
      <div className="relative z-10 mx-auto xl:max-w-7xl sm:max-w-4xl md:max-w-5xl lg:max-w-6xl">
        ...
        <div className="space-y-2 pt-2 lg:space-y-6 lg:pt-6 text-lg leading-8 text-gray-700 transition-all duration-500 group-hover:text-white">
  ...
  return (
    <div className="overflow-hidden bg-gray-50 rounded-3xl p-6 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:shadow-3xl min-w-[500px] min-h-[500]">
      ...
      <div className="z-10 mx-auto min-w-3xl">
        ...
        <div className="space-y-2 pt-2 lg:space-y-6 lg:pt-6 text-lg leading-8 min-w-3xl">
