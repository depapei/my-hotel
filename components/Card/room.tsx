export const RoomCard = (props: {
  ...
  return (
    <div
      className="group relative overflow-hidden bg-white rounded-2xl px-6 pt-12 pb-10 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:scale-105 hover:shadow-3xl m-8 lg:m-0"
      onClick={onClick}
    >
