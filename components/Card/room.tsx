export const RoomCard = (props: {
  ...
  return (
    <div
      className="group relative overflow-hidden bg-white rounded-3xl px-6 pt-6 pb-10 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:scale-105 hover:shadow-3xl m-8 lg:m-0"
      onClick={onClick}
    >
...
export const RoomCardLoading = () => {
  return (
    <div className="overflow-hidden bg-gray-50 rounded-3xl px-6 pt-6 pb-10 shadow-2xl ring-1 ring-gray-900/5 transition-all duration-500 transform hover:shadow-3xl min-w-[500px] min-h-[500]">
      <span className="absolute top-0 left-0 z-0 h-24 w-full bg-gradient-to-r from-purple-500 to-blue-500 opacity-75 transition-all duration-500 transform group-hover:scale-[20]"></span>
